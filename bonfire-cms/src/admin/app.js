...
import AuthLogo from './extensions/fire_emoji.png';
import MenuLogo from './extensions/fire_emoji.png';
import favicon from './extensions/fire_emoji.png';

export default {
  config: {
    // Replace the Bonfire logo in auth (login) views
    auth: {
      logo: AuthLogo,
    },
   // Replace the favicon
    ...
    locales: ['fr', 'de'],
    // Replace the Bonfire logo in the main navigation
    menu: {
      logo: MenuLogo,
    },
    ...
    translations: {
      ...
      en: {
        ...
        "Auth.form.button.login.strapi": "Log in via Bonfire",
        ...
        "Auth.form.register.subtitle": "Credentials are only used to authenticate in Bonfire. All saved data will be stored in your database.",
        "Auth.form.rememberMe.label": "Remember me",
        "Auth.form.username.label": "Username",
        "Auth.form.username.placeholder": "e.g. Kai_Doe",
        "Auth.form.welcome.subtitle": "Log in to your Bonfire account",
        "Auth.form.welcome.title": "Welcome to Bonfire!",
        ...
        "HomePage.welcome.congrats.content": "You are logged in as the first administrator. To discover the powerful features provided by Bonfire,",
        ...
        "Settings.permissions.users.listview.header.subtitle": "All the users who have access to the bonfire admin panel",
        ...
        "admin.pages.MarketPlacePage.offline.subtitle": "You need to be connected to the Internet to access Bonfire Market.",
        ...
        "admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi": "Made by Bonfire",
        "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin verified by Bonfire",
        ...
        "admin.pages.MarketPlacePage.subtitle": "Get more out of Bonfire",
        "admin.pages.MarketPlacePage.tab-group.label": "Plugins and Providers for Bonfire",
        ...
        "app.components.BlockLink.blog.content": "Read the latest news about Bonfire and the ecosystem.",
        "app.components.BlockLink.cloud": "Bonfire Cloud",
        ...
        "app.components.BlockLink.tutorial.content": "Follow step-by-step instructions to use and customize Bonfire.",
        ...
        "app.components.HomePage.welcomeBlock.content": "Congrats! You are logged as the first administrator. To discover the powerful features provided by Bonfire, we recommend you to create your first Content type!",
        "app.components.HomePage.welcomeBlock.content.again": "We hope you are making progress on your project! Feel free to read the latest news about Bonfire. We are giving our best to improve the product based on your feedback.",
        ...
        "app.components.LeftMenu.navbrand.title": "Bonfire Dashboard",
        ...
        "app.components.MarketplaceBanner": "Discover plugins built by the community, and many more awesome things to kickstart your project, on Bonfire Marketplace.",
        "app.components.MarketplaceBanner.image.alt": "A Bonfire rocket logo",
        ...
        "components.AutoReloadBlocker.description": "Run Bonfire with one of the following commands:",
        ...
        "global.plugins.sentry.description": "Send Bonfire error events to Sentry.",
        ...
        "notification.ee.warning.over-.message": "Add seats to {licenseLimitStatus, select, OVER_LIMIT {invite} AT_LIMIT {re-enable}} Users. If you already did it but it's not reflected in Bonfire yet, make sure to restart your app.",
        ...
        "notification.version.update.message": "A new version of Bonfire is available!",
   ...
   // Disable video tutorials
    tutorials: false,
   // Disable notifications about new Bonfire releases
